...
lyr_DICTMasbateProvincialOffice_5.set('fieldAliases', {'photo': 'photo', 'filename': 'filename', 'longitude': 'longitude', 'latitude': 'latitude', 'Office Hours': 'Office Hours', });
...
lyr_DICTMasbateProvincialOffice_5.set('fieldImages', {'photo': 'ExternalResource', 'filename': 'TextEdit', 'longitude': 'TextEdit', 'latitude': 'TextEdit', 'Office Hours': '', });
...
lyr_DICTMasbateProvincialOffice_5.set('fieldLabels', {'photo': 'no label', 'filename': 'no label', 'longitude': 'inline label', 'latitude': 'inline label', 'Office Hours': 'inline label', });
